        ...
        view: function *loadView(name) {
            if(koars.dev() || !cache[name]) {
                ...
                try {
                    ...
                    if(e.code === 'MODULE_NOT_FOUND' && e.message.contains(name)) {
        ...
        layout: function *loadLayout() {
            if(koars.dev() || !cache.layout) {
                ...
                try {
                    ...
                    if(e.code === 'MODULE_NOT_FOUND' && e.message.contains('layout.js')) {
                        data = function *() {return {};};
                    } else {
                        throw e;
                    }
        ...
        frame: function *loadFrame() {
            if(koars.dev() || !cache.frame) {
                ...
                try {
                    ...
                    if(e.code === 'MODULE_NOT_FOUND' && e.message.contains('frame.js')) {
                        data = function *() {return {};};
                    } else {
                        throw e;
                    }
